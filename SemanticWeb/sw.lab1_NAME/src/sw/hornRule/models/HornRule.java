...
public class HornRule extends Formalism{
	...
	public boolean equals(Object obj) {
	    ...
	    if (!(obj instanceof HornRule))return false;
		return (this.getConditions().equals(((HornRule)obj).getConditions())&&((this.getConclusions().equals(((HornRule)obj).getConclusions()))));
	}
	@Override
	public int hashCode() {
		  return getConclusions().size()+getConditions().size();
	}
}
