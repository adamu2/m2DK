...
COMMENT ON COLUMN CATEGORIES.CATEGORY_ID IS 'NUMERIC automatically assigned to a new category.';
...
COMMENT ON COLUMN CUSTOMERS.PHONE IS 'Phone NUMERIC includes country code or area code.';

COMMENT ON COLUMN CUSTOMERS.FAX IS 'Phone NUMERIC includes country code or area code.';
...
CREATE FUNCTION emp_birthdate() RETURNS trigger AS $emp_birthdate$
    BEGIN
		...
		return new;
    END;
$emp_birthdate$ LANGUAGE plpgsql;
...
OF BIRTHDATE
ON EMPLOYEES 
FOR EACH ROW EXECUTE PROCEDURE emp_birthdate();
...
COMMENT ON COLUMN EMPLOYEES.EMPLOYEE_ID IS 'NUMERIC automatically assigned to new employee.';
...
COMMENT ON COLUMN EMPLOYEES.HOME_PHONE IS 'Phone NUMERIC includes country code or area code.';

COMMENT ON COLUMN EMPLOYEES.EXTENSION IS 'Internal telephone extension NUMERIC.';
...
(
    SUPPLIER_ID NUMERIC(9) NOT NULL,
    COMPANY_NAME VARCHAR(40 ) NOT NULL,
    CONTACT_NAME VARCHAR(30 ),
    CONTACT_TITLE VARCHAR(30 ),
    ADDRESS VARCHAR(60 ),
...
COMMENT ON COLUMN SUPPLIERS.SUPPLIER_ID IS 'NUMERIC automatically assigned to new supplier.';

COMMENT ON COLUMN SUPPLIERS.ADDRESS IS 'Street or post-office box.';

COMMENT ON COLUMN SUPPLIERS.REGION IS 'State or province.';

COMMENT ON COLUMN SUPPLIERS.PHONE IS 'Phone NUMERIC includes country code or area code.';

COMMENT ON COLUMN SUPPLIERS.FAX IS 'Phone NUMERIC includes country code or area code.';
...
COMMENT ON COLUMN SHIPPERS.SHIPPER_ID IS 'NUMERIC automatically assigned to new shipper.';

COMMENT ON COLUMN SHIPPERS.COMPANY_NAME IS 'Name of shipping company.';

COMMENT ON COLUMN SHIPPERS.PHONE IS 'Phone NUMERIC includes country code or area code.';
...
(
    PRODUCT_ID NUMERIC(9) NOT NULL,
    PRODUCT_NAME VARCHAR(40 ) NOT NULL,
    SUPPLIER_ID NUMERIC(9) NOT NULL,
    CATEGORY_ID NUMERIC(9) NOT NULL,
    QUANTITY_PER_UNIT VARCHAR(20 ),
    UNIT_PRICE NUMERIC(10,2) DEFAULT 0 NOT NULL CONSTRAINT CK_PRODUCTS_UNIT_PRICE CHECK (Unit_Price>=0),
    UNITS_IN_STOCK NUMERIC(9) DEFAULT 0 NOT NULL CONSTRAINT CK_PRODUCTS_UNITS_IN_STOCK CHECK (Units_In_Stock>=0),
    UNITS_ON_ORDER NUMERIC(9) DEFAULT 0 NOT NULL CONSTRAINT CK_PRODUCTS_UNITS_ON_ORDER CHECK (Units_On_Order>=0),
    REORDER_LEVEL NUMERIC(9) DEFAULT 0 NOT NULL CONSTRAINT CK_PRODUCTS_REORDER_LEVEL CHECK (Reorder_Level>=0),
...
COMMENT ON COLUMN PRODUCTS.PRODUCT_ID IS 'NUMERIC automatically assigned to new product.';
...
COMMENT ON COLUMN ORDERS.ORDER_ID IS 'Unique order NUMERIC.';
...
(
    ORDER_ID NUMERIC(9) NOT NULL,
    PRODUCT_ID NUMERIC(9) NOT NULL,
    UNIT_PRICE NUMERIC(10,2) DEFAULT 0 NOT NULL CONSTRAINT CK_ORDER_DETAILS_UNIT_PRICE CHECK (Unit_Price>=0),
    QUANTITY NUMERIC(9) DEFAULT 1 NOT NULL CONSTRAINT CK_ORDER_DETAILS_QUANTITY CHECK (Quantity>0),
    DISCOUNT NUMERIC(4,2) DEFAULT 0 NOT NULL CONSTRAINT CK_ORDER_DETAILS_DISCOUNT CHECK (Discount between 0 and 1),
